        ...
        return (
            <View style={TabBarStyle.TabItems}>
                <View style={TabBarStyle.TabBarIcon}>
                    <SvgXml width={'25'} xml={this.image} />
                </View>
                <Text style={[TabBarStyle.IconDescription,
                    FontStyles.small,
                    FontStyles.bold
                ]}>{ t(this.text)}</Text>
            </View>
        ...
        return (
            <View style={TabBarStyle.TabItems}>
                <View style={TabBarStyle.CenterIcon}>
                    <SvgXml width={'60'} xml={this.image} />
                </View>
                <Text style={[TabBarStyle.CenterIconDescription,
                    FontStyles.small,
                    FontStyles.bold
                ]}>{t(this.text)}</Text>
            </View>
...
const TabBar = () => {
    const TabItem1JSX = new TabItem(bottomIcon.bottom_icon_1, 'Main').getTabItem();
    const TabItem2JSX = new TabItem(bottomIcon.bottom_icon_2, "Today").getTabItem();
    const TabItem3JSX = new TabItem(bottomIcon.bottom_icon_cat, "Let's Go!").getCenterItem();
    const TabItem4JSX = new TabItem(bottomIcon.bottom_icon_3, "Clock").getTabItem();
    const TabItem5JSX = new TabItem(bottomIcon.bottom_icon_4, "Q wallet").getTabItem();
    const { t, i18n } = useTranslation();
    return (
